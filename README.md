...
8. Set frmStopwatch modal property to false. (note: When Modal = false, the user can interact with the workbook. Otherwise, the form must be dismissed to access the workbook.)
